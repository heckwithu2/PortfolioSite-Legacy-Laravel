    ...
    cvEntries : [
        {
            ...
            company: "Carimus",
            body: "In my final semester of Kent State, I took on an internship at Carimus, a software company that focuses on creating a brand, design and business plan for start-up companies. Though located in downtown Raleigh, I worked remotely to fix bugs, and add spanish translations to an app called Luma. The front-end was built in React, Redux and Saga among other libraries, and the back-end was in Spring.",
        ...
        },
        {
            ...
            body: "I was rehired by Kasper Holdings during my Junior year summer semester to contribute on the TradeFull platform. I continued to learn Laravel, and regularly used Microsoft SQL Server, Bootstrap and more to fix various bugs.",
        ...
        },
        {
            ...
            company: "Kasper Holdings, Inc",
            body: "During my sophomore year summer semester I was hired to contribute to the front page of Kasper Holdings now legacy eCommerce site, AreaTrend. I worked with artists and marketing to implement mock-ups in Bootstrap, HTML, CSS, using Laravel on the back end.",
        ...
        },
        {
            ...
            body: "During my time at KSU, I pursued my interest in Video Games, and joined the Animation and Game Design Club. I initially volunteered to be the treasurer, and was eventually voted in as the President of the club. I organized many events with my fellow club members, including two Global Game Jams and trips to multiple game conventions.",
        ...
        },
        {
            ...
            body: "After HighSchool I joined the Army on active duty as a Combat Medic Specialist 68W. I learned many things: leadership, communication, confidence, self-reliance and more. I worked my way into the communications position at the company level, where I obtained a Secret Clearance, and was in charge of millions of dollars of equipment and its functionality.",
